...
import com.metapro.dao.MstBankDao;
 ...
 */
@WebServlet(urlPatterns = "/api/semstbank")
public class semstbank extends HttpServlet {
    ...
    MstBankDao bankDao = new MstBankDao();
...
//                }
                ...
                Vector<MstBank> listBank = new Vector<>();
                listBank = bankDao.getDataBankAll();
                result.put("STATUS", "OK");
                result.put("MESSAGE", "SUCCESS");
                result.put("DATA", listBank);
...
//                airline.setTimeUpdate(Time.valueOf(CigistDateTimeNow.getDateTimeNow("hh:mm:ss")));
//
//                boolean resultInsert = bankDao.changeAktif(airline);
//                if (resultInsert) {
//                    result.put("STATUS", "OK");
//                    result.put("MESSAGE", "SUCCESS");
//                    result.put("DATA", "");

 ...
 */
package com.metapro.service.metapay;

import com.metapro.service.*;
 ...
 */
@WebServlet(urlPatterns = "/api/metapay/payment")
public class payment extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        boolean checkPin = valid.checkAccount(accountNumber, pin);

        if (status && validate && checkPin) {

 ...
 */
@WebServlet(urlPatterns = "/api/setariktunai")
public class setariktunai extends HttpServlet {
...
//                        service.updateSaldo(accountNumber, nominalValue);
                if (result) {
                    dataTran = trnDao.getDataTran(trnNasabah);
                    obj.put("MESSAGE", "TARIK TUNAI BERHASIL, AGEN TERDEKAT AKAN SEGERA DATANG");
                    obj.put("STATUS", "OK");
                    obj.put("DATA", dataTran);
                } else {
                    obj.put("MESSAGE", "TARIK TUNAI GAGAl!");

 ...
 */
@WebServlet(urlPatterns = "/api/seprint")
public class seprint extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            fis = new FileInputStream(reportLocation + "/report/TrnRpt.jasper");
            ...
            try {
                ...
                Logger.getLogger(seprint.class.getName()).log(Level.SEVERE, null, ex);
            }

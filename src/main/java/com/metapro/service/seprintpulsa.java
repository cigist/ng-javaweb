 ...
 */
@WebServlet(urlPatterns = "/api/seprintpulsa")
public class seprintpulsa extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            fis = new FileInputStream(reportLocation + "/report/RptPulsa.jasper");
            ...
            try {
                ...
                Logger.getLogger(seprintpulsa.class.getName()).log(Level.SEVERE, null, ex);
            }

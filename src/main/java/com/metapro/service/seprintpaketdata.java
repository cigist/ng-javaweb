 ...
 */
@WebServlet(urlPatterns = "/api/seprintpaketdata")
public class seprintpaketdata extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            fis = new FileInputStream(reportLocation + "/report/RptPaketData.jasper");
            ...
            try {
                ...
                Logger.getLogger(seprintpaketdata.class.getName()).log(Level.SEVERE, null, ex);
            }

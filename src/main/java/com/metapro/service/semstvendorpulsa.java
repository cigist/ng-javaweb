 ...
 */
@WebServlet(urlPatterns = "/api/semstvendorpulsa")
public class semstvendorpulsa extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String vendorCode = request.getParameter("xvendorcode");
        ...
        if (validateAccount) {
            if (action.equals("insert")) {
                ...
                listVendor = vendorDao.getByVendorType(type);
                result.put("STATUS", "OK");
                result.put("MESSAGE", "SUCCESS");
                result.put("DATA", listVendor);
            } else if (action.equals("pulsa")) {
                Vector<MstPulsa> listPulsa = new Vector<>();
                listPulsa = vendorDao.getAllDataPulsa(vendorCode);
                result.put("STATUS", "OK");
                result.put("MESSAGE", "SUCCESS");
                result.put("DATA", listPulsa);
            } else if (action.equals("data")) {
                Vector<MstPulsa> listData = new Vector<>();
                listData = vendorDao.getAllPaketData(vendorCode);
                result.put("STATUS", "OK");
                result.put("MESSAGE", "SUCCESS");
                result.put("DATA", listData);
            }else if (action.equals("game")) {
                Vector<MstPulsa> listData = new Vector<>();
                listData = vendorDao.getAllGame(vendorCode);
                result.put("STATUS", "OK");
                result.put("MESSAGE", "SUCCESS");
                result.put("DATA", listData);
            }else if (action.equals("payment")) {
                Vector<MstPulsa> listData = new Vector<>();
                listData = vendorDao.getAllDataPayment(vendorCode);
                result.put("STATUS", "OK");
                result.put("MESSAGE", "SUCCESS");
                result.put("DATA", listData);
            }

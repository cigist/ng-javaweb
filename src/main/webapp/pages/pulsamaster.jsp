...
--%>
<!-- Main content -->
<div class="box-body" ng-controller="MstPulsaController">
    <div class="box-header">
        <h3 class="box-title">Master Pulsa</h3>
    </div>
        ...
        <div class="box-body">
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" ng-model="pulsacode">
                </div>
                <div class="form-group">
                    <label>Description</label>
                    <input type="text" class="form-control" ng-model="pulsaname">
                </div>
                <div class="form-group">
                    <label>Amount</label>

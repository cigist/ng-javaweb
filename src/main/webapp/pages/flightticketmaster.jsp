...
--%>
<!-- Main content -->
<div class="box-body" ng-controller="MstMaskapaiController">
        ...
        <div class="box-body">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="airlinecode" ng-model="airlinecode">
                </div>
                <div class="form-group">
                    <label>Description</label>
                    <input type="text" class="form-control" ng-model="airlinename">
                </div>
                <div class="form-group">
